...
function Footer() {
  ...
  const githubUrl = () => {
    window.open('https://github.com/lonelypheonix')
  }

  const instagramUrl = () => {
    window.open('https://www.instagram.com/_lonely_pheonix_/')
  }
  
  return (
    <div className="footer">
      <h1>
        <span className="white">Ani</span>Pass
      </h1>
      <p className="footer-about">
        AniPass is not affiliated with or endorsed by any of the anime studios
